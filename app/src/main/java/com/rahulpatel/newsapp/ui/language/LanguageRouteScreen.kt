...
import com.rahulpatel.newsapp.ui.theme.pink

@Composable
fun LanguageListRoute(
    onLanguageClick: (languageID: String) -> Unit,
    languageListViewModel: LanguageListViewModel = hiltViewModel()
) {
    val languageUiState by languageListViewModel.languageUiState.collectAsStateWithLifecycle()
