package com.rahulpatel.newsapp.ui.home
...
import com.rahulpatel.newsapp.ui.base.Route
...
fun HomeScreenRoute(navController: NavController) {
    ...
    Column(
        modifier = Modifier.fillMaxWidth(), // Make the column take full horizontal space
        verticalArrangement = Arrangement.Center, // Position children vertically in the center
        horizontalAlignment = Alignment.CenterHorizontally // Align children horizontally in the center
    ) {

        // Load the actual UI of the Home screen
        // Passing navController to handle navigation events inside HomeScreen
...
fun TitleButton(title: String, navController: NavController, routeName: String) {
    Button(
        ...
        modifier = Modifier
            .padding(start = 25.dp, top = 5.dp, end = 20.dp, bottom = 5.dp)
            .fillMaxWidth(),
